...
import { isConfigured, callOpenAI } from './openai.js';
 ...
 */
export function generatePreview(product, sections, font) {
 ...
 */
export async function generatePreviewWithAI(product, sections, font) {
  if (!isConfigured()) {
