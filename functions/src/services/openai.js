 ...
 */
async function improveDescription(productName, currentDescription, sections) {
 ...
 */
async function generateSeoWithAI(productName, description, tags, currentTitle, currentDesc) {
